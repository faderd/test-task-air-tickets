...
function TicketCard({ ticket, currencySymbol }: TicketCardProps): JSX.Element {
    ...
    <div className={styles['ticket-card']}>
      ...
      <div className={styles['ticket-card__info']}>
        <div className={styles['ticket-card__times']}>
          ...
          <div className={styles['ticket-card__stops']}>{ticket.stops} {addDeclension(ticket.stops, 'пересадка', 'пересадки', 'пересадок')}</div>
